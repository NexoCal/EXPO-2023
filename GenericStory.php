...
$result_story = mysqli_query($conn, "SELECT id_story,gambar,judul,isi,deskripsi_story,artikel FROM `story` where id_story = $id");
$rows = mysqli_fetch_array($result_story, MYSQLI_ASSOC);
?>
...
<head>
    ...
    <title><?php echo $rows['judul'];?></title>
...
<body>
    ...
    <div class="content">
        <div class="img-container">
            <img src="assets/image/Stories/<?php echo $rows['gambar'];?>" alt="">
        </div>
        <div class="judul-arti"><h1><?php echo $rows['judul'];?></h1></div>
        <div class="paraga"><p><?php echo $rows['isi'];?></p></div>
