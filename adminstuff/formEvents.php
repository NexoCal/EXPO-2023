                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_GET['id'])) {
                                $selectID = $_GET['id'];
                                $results = mysqli_query($conn, "SELECT e.gambar,e.judul,e.deskripsi,e.tanggal,e.timeline, k.kategoriEvent FROM events e join kategori_event k on (e.id_kategori_event=k.id_kategori_event) WHERE e.id_events = '$selectID'");
                                ...
                                <form action="additem.php" method="post">
                                    <div class="flex-container-form">
                                        ...
                                        <div>
                                            ...
                                            <button style="width: 10%;" type="submit" value="cancel-event" name="submit-button" id="buttons">Cancel</button>
                                        </div>
                                    </div>
